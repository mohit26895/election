...
//page.
 ...
 //Prepare query
 $query = "SELECT student_info.name,candidate_info.rollno FROM candidate_info INNER JOIN student_info ON student_info.rollno=candidate_info.rollno WHERE branch = '$branch'";
 //Execute query
 ...
 {
	 echo '<br><br><br><h1 class="middle">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp You Have already Casted your Vote!!!</h1><br><br><br>';
 }
